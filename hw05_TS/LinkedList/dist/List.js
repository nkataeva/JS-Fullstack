...
class List {
    ...
    delete(value) {
        ...
        if (((_a = this.tail) === null || _a === void 0 ? void 0 : _a.value) == value) {
...
(_a = list.find("AAAA")) === null || _a === void 0 ? void 0 : _a.printNode();
(_c = (_b = list.delete("AAAA")) === null || _b === void 0 ? void 0 : _b.delete("909")) === null || _c === void 0 ? void 0 : _c.delete("qwerty");
